...
class Brands extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: isDesktop(context) ? const EdgeInsets.only(bottom: 64.0) : EdgeInsets.only(bottom: 32.0),
      child: Column(
        children: [
          if (isMobile(context))
            Padding(padding: const EdgeInsets.only(left: 24.0, right: 24.0, bottom: 32.0), child: Column(children: [
              GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
